...
import (
	...
	"factory-service/internal/database"
	"factory-service/internal/handlers"
	"factory-service/internal/kafka"
	"factory-service/internal/logger"
	"factory-service/internal/redis"
	"factory-service/internal/server"
	"factory-service/internal/websocket"
)
...
func main() {
	...
	logger.Info("Starting Factory Service", "version", "1.0.0")
