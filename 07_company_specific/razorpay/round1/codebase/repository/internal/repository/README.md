...
**Related files:**
- [mysql_repository.go](./mysql_repository.go)
- [mongo_repository.go](./mongo_repository.go)
- [cached_repository.go](./cached_repository.go)
- [interfaces.go](./interfaces.go)
- [repository_factory.go](./repository_factory.go)
- [unit_of_work.go](./unit_of_work.go)
