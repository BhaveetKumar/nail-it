...
Title: Readme
LastUpdated: 2025-11-06T20:45:58.603638
Tags: []
Status: draft
---
...
**Related files:**
- [payment_factory.go](./payment_factory.go)
- [notification_factory.go](./notification_factory.go)
- [abstract_factory.go](./abstract_factory.go)
- [database_factory.go](./database_factory.go)
