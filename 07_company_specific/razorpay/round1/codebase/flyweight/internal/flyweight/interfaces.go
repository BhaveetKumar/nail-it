...
type Flyweight interface {
	GetIntrinsicState() map[string]interface{}
	GetType() string
	GetID() string
	IsShared() bool
...
// FlyweightFactory defines the interface for flyweight factory
type FlyweightFactory interface {
	GetFlyweight(key string) (Flyweight, error)
	CreateFlyweight(key string, intrinsicState map[string]interface{}) (Flyweight, error)
	GetFlyweightCount() int
	GetFlyweightTypes() []string
	ClearUnusedFlyweights()
